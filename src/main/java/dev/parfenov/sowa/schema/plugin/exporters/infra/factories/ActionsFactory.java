...
public class ActionsFactory {
    ...
    public ServicesYaml.Action createRequestAction(ClassModel classModel, MethodModel method) {
        var actions = getActions(method.getRequest().getType());
    ...
    public ServicesYaml.Action createResponseAction(ClassModel classModel, MethodModel method) {
        var actions = getActions(method.getResponse().getType());
    ...
    /**
     * Стратегия выбора {@link Actions} в зависимости от входного типа
     *
     * @param type тип объекта
     * @return {@link Actions} в зависимости от типа
     */
    private Actions getActions(Type type) {
        return type == null || TypesParser.isVoid(type)
