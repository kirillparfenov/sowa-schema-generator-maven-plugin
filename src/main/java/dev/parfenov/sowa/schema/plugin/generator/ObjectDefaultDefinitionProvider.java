 ...
 * </p>
 *
 * @author Кирилл Парфенов (@kirillparfenov)
 * @see CustomDefinitionProviderV2
 */
public class ObjectDefaultDefinitionProvider implements CustomDefinitionProviderV2 {
    ...
    /**
     * Строит кастомное определение схемы для типа Object.
     * <p>
     ...
     * <ul>
     * <li>additionalProperties: true - разрешает дополнительные свойства</li>
     * <li>type: массив доступных типов (object, null)</li>
     * </ul>
     * </p>
     *
     * @param context контекст генерации схемы
     ...
     * <ul>
     * <li>"object" - для объектных значений</li>
     * <li>"null" - для null значений</li>
     * </ul>
     * </p>
     *
     * @param context контекст генерации схемы
     * @return ArrayNode с доступными типами
     */
